...
game.StarterGui:SetCore('SendNotification',{Title='khang nguyễn',Text='Thanks for using!',Icon='http://www.roblox.com/asset/?id=8941506186',Duration=5,Button1='discord.gg/XXqzxT7E5z',Callback=e})
local a=''
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/Its-khang/khang-Hub-Old/main/Universal/.lua')..a)()
